...
public class MouseWellController : MonoBehaviour
{
    ...
    public float GetCurrentInputPosition(){
        if(cPosition == CubePosition.Left){
            ...
            //return Mathf.Min(0.001f,-1.499f * Mathf.Clamp((GameManager.Instance.SmoothedMousePosition.x / Screen.width),0f,1f));
            ...
            //return Mathf.Max(0.001f,1.499f * Mathf.Clamp((GameManager.Instance.SmoothedMousePosition.y / Screen.height),0f,1f));
        } else {
            return 0;
        }
    }
